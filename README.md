...
**العرض الحيّ (Live Demo):** https://mohammad-nour-aldeen-gis-medical-dashboard.vercel.app/
...
- خريطة GIS حيّة (Leaflet) مع تجميع العلامات، مشافٍ ملوّنة حسب الحالة، سيارات إسعاف متحركة، وخطوط توجيه مرسومة.
...
│   │       └── markerIcons.ts            # تعريف علامات الخريطة (مشفى / إسعاف / حادث) حسب الحالة
│   │
